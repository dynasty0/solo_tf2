...
class FutureDataset():
    def __init__(self, path, augmentation = True, shape = (512,512), max_size = 64):
        self.path = path
    ...
    def decode(self,data):
        ...
        # _area = tf.reduce_sum(mask, axis = [1,2])
...
# train_record_path = "/home/notebook/data/personal/3d-future/tfrecords/train_1200.tfrecords"
# train_dataset = FutureDataset(train_record_path, shape = (1200, 1200))
# train_dataset = train_dataset.run(epoches=1, batch_size=1)

# area_list = []
# import numpy as np
# for data in train_dataset:
#     area_list.append( data['area'][0].numpy() )

# area_array = np.concatenate(area_list,axis=0)
# # area = np.asarray(area_list)
# num = [0,0,0,0,0]
# for a in area_array:
#     if a>10 and a<12000:
#         num[0] +=1
#     if a >= 8000 and a< 24000:
#         num[1] +=1
#     if a >= 20000 and a< 42000:
#         num[2] +=1
#     if a >= 38000 and a< 82000:
#         num[3] +=1
#     if a>= 78000:
#         num[4] +=1

# print(num)
# print(np.max(area_array))
# print(np.min(area_array))