...
from .utils import bboxes_intersection
...
# def geometric_distortion(parsed_tensors, output_size):
    # img = parsed_tensors["image"]
    # ymin = parsed_tensors["ymin"]
    # xmin = parsed_tensors["xmin"]
    # ymax = parsed_tensors["ymax"]
    # xmax = parsed_tensors["xmax"]
    # bboxes = tf.stack([ymin, xmin, ymax, xmax], axis = 1)
    # masks = parsed_tensors["mask"]
    # classes = parsed_tensors["category"]
    ...
    # print("bbox_begin.shape: ",bbox_begin.shape)
    # print("bbox_size.shape: ", bbox_size.shape)
...
def random_augmentation(img, bboxes, masks, classes, output_size, proto_output_size):
    # generate random
